...
export class TelegramAlerter {
  ...
  async _initializeBotCommands() {
    ...
    // Use default scope — chat-scoped registration fails for private chats
    // until the user has messaged the bot. Execution is already restricted
    // to the configured chatId in _pollUpdates.
